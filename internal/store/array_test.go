...
func TestArrayStore_PutGetAndRefuseOverwrite(t *testing.T) {
	...
	disks := []ArrayDisk{
		{Role: ArrayRoleParity, RoleIndex: 1, Device: "/dev/sda", Filesystem: "xfs", FSUUID: "uuid-p", WWN: "wwn-p", Mountpoint: "/mnt/parity1"},
		{Role: ArrayRoleData, RoleIndex: 1, Device: "/dev/sdb", Filesystem: "xfs", FSUUID: "uuid-d", Serial: "DATA1", Mountpoint: "/mnt/disk1"},
		{Role: ArrayRoleCache, RoleIndex: 1, Device: "/dev/sdc", Filesystem: "ext4", FSUUID: "uuid-c", Mountpoint: "/mnt/cache"},
	}
