...
var operationRoles = map[apiv1.OperationName]Role{
	...
	apiv1.UpdateUPSSettingsOperation:              RoleAdmin,
	...
	apiv1.StartShareRelocationOperation:           RoleAdmin,
