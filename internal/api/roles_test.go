...
func TestOperationRolesCoversEveryGeneratedOperation(t *testing.T) {
	generated := []apiv1.OperationName{
		apiv1.AcknowledgeDegradedArrayOperation,
		...
		apiv1.GetUPSSettingsOperation,
		apiv1.GetSchedulesOperation,
		apiv1.GetJobOperation,
		apiv1.GetJobLogOperation,
		apiv1.GetLastMoverRunOperation,
		...
		apiv1.ListNotificationsOperation,
		apiv1.LoginOperation,
		apiv1.MarkNotificationsReadOperation,
		...
		apiv1.UpdateUPSSettingsOperation,
		...
		apiv1.GetUpdateStatusOperation,
		apiv1.UpdateUpdateSettingsOperation,
		apiv1.CheckForUpdateOperation,
