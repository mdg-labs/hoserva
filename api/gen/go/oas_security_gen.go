...
var operationRolesApiToken = map[string][]string{
	AcknowledgeDegradedArrayOperation:       []string{},
	AddDiskOperation:                        []string{},
	ApplyHostConfigOperation:                []string{},
	ApplyNetworkSettingsOperation:           []string{},
	ApplyUpdateOperation:                    []string{},
	BrowseShareOperation:                    []string{},
	CancelDiskRemovalOperation:              []string{},
	CancelJobOperation:                      []string{},
	CheckForUpdateOperation:                 []string{},
	ConfigureLetsEncryptOperation:           []string{},
	ConfirmNetworkSettingsOperation:         []string{},
	ConfirmTotpOperation:                    []string{},
	CreateApiTokenOperation:                 []string{},
	...
	CreateUserGroupOperation:                []string{},
	DeleteNotificationChannelOperation:      []string{},
	DeleteShareOperation:                    []string{},
	DeleteShareDataOperation:                []string{},
	DeleteShareFileOperation:                []string{},
	DeleteUserOperation:                     []string{},
	DeleteUserGroupOperation:                []string{},
	DisableLetsEncryptOperation:             []string{},
	DisableUserTotpOperation:                []string{},
	EjectExternalDiskOperation:              []string{},
	EnrollTotpOperation:                     []string{},
	EvacuateDiskOperation:                   []string{},
	ExportConfigOperation:                   []string{},
	FinishDiskRemovalOperation:              []string{},
	FormatExternalDiskOperation:             []string{},
	GetCacheUsageOperation:                  []string{},
	GetCurrentSessionOperation:              []string{},
	GetGeneralSettingsOperation:             []string{},
	GetJobOperation:                         []string{},
	GetJobLogOperation:                      []string{},
	GetLastMoverRunOperation:                []string{},
	GetMetricsOperation:                     []string{},
	GetNetworkSettingsOperation:             []string{},
	GetNotificationChannelOperation:         []string{},
	GetNotificationRoutingOperation:         []string{},
	GetParityOperation:                      []string{},
	GetPoolOperation:                        []string{},
	GetQuietHoursOperation:                  []string{},
	GetSchedulesOperation:                   []string{},
	GetShareOperation:                       []string{},
	GetSharePermissionsOperation:            []string{},
	GetStatusOperation:                      []string{},
	GetUPSSettingsOperation:                 []string{},
	GetUpdateStatusOperation:                []string{},
	GetUserSharePermissionsOperation:        []string{},
	ImportConfigOperation:                   []string{},
	ListApiTokensOperation:                  []string{},
	ListDisksOperation:                      []string{},
	ListExternalDisksOperation:              []string{},
	...
	ListUserGroupsOperation:                 []string{},
	...
	PlanDiskEvacuationOperation:             []string{},
	PlanDiskReplaceOperation:                []string{},
	PlanDiskUpgradeOperation:                []string{},
	PlanRebalanceOperation:                  []string{},
	...
	SetUserGroupMembersOperation:            []string{},
	SetUserPasswordOperation:                []string{},
	StartArrayOperation:                     []string{},
	StartFixOperation:                       []string{},
	StartMoverOperation:                     []string{},
	StartRebalanceOperation:                 []string{},
	StartScrubOperation:                     []string{},
	StartShareRelocationOperation:           []string{},
	StartSyncOperation:                      []string{},
	StopArrayOperation:                      []string{},
	UnlockUserOperation:                     []string{},
	UpdateExternalDiskOperation:             []string{},
	UpdateGeneralSettingsOperation:          []string{},
	UpdateMaintenanceChainScheduleOperation: []string{},
	...
	UpdateSharePermissionsOperation:         []string{},
	UpdateUPSSettingsOperation:              []string{},
